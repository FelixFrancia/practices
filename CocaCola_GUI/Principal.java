...
public class Principal extends JFrame implements ActionListener{
 ...
 public Principal(){
   ...
   labelBienvenido = new JLabel("Bienvenid@ " + nombreAdministrador );
   ...
   comboDepartamento.setBackground(new java.awt.Color(225, 224, 224));
   ...
   comboDepartamento.addItem("Departemento de Logistica");
   ...
   comboAntiguedad.setBackground(new java.awt.Color(225, 224, 224));
   ...
   labelfooter = new JLabel("@2018 The Coca-Cola Company ~ By Felix Francia");
 ...
 public void actionPerformed(ActionEvent e){
   ...
   if (e.getSource() == miNegro){
    ...
    if (e.getSource() == miElCreador){
	   JOptionPane.showMessageDialog(null, " Desarollado por Felix Francia. ");
   }
 }
